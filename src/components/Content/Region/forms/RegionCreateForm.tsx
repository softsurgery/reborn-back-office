...
import { useCreateRegionFormStructure } from "./useCreateRegionFormStructure";
...
export const RegionCreateForm: React.FC<RegionFormProps> = ({
  className,
  regionCallback,
  cancelCallback,
  isPending,
  ...
  const { regionCreateFormStructure } = useCreateRegionFormStructure({
    regionStore,
  });
  ...
  return (
    ...
    >
      <FormBuilder
        ...
        structure={regionCreateFormStructure}
      />
