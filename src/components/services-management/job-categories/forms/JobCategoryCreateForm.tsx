...
import { useCreateJobCategoryFormStructure } from "./useCreateJobCategoryFormStructure";
...
export const JobCategoryCreateForm: React.FC<JobCategoryFormProps> = ({
  className,
  jobCategoryCallback,
  cancelCallback,
  isPending,
  ...
  const { jobCategoryCreateFormStructure } = useCreateJobCategoryFormStructure({
    jobCategoryStore,
  });
  ...
  return (
    ...
    >
      <FormBuilder
        ...
        structure={jobCategoryCreateFormStructure}
      />
